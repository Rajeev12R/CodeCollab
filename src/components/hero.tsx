      ...
      <div className="relative z-10 text-white max-w-6xl mx-auto space-y-8">
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Experience real-time collaboration, seamless GitHub integration, and
            powerful development tools all in one beautiful, intuitive platform.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button
            ...
            className="bg-background text-black hover:bg-gray-200 text-lg px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Get Started Free
          </Button>
          <Button
